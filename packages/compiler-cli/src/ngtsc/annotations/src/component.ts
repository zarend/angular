...
export class ComponentDecoratorHandler implements
  ...
  constructor(
      ...
      private typeCheckScopeRegistry: TypeCheckScopeRegistry|null,
  ...
  compileFull(
    ...
    if (analysis.template.errors) {
      throw syntaxError(`cannot compile a component with parse errors`, analysis.template.errors);
    }
