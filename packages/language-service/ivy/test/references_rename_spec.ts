...
describe('find references and find rename locations', () => {
  ...
  describe('when external template with binding and cursor over binding defn', () => {
    let cursor: number;
    ...
    it('gets rename locations from TS file', () => {
